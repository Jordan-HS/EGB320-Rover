...
def init_sim():
    ...
    sceneParameters.obstacle0_StartingPosition = [0.8, 0]  # starting position of obstacle 0 [x, y] (in metres), -1 if want to use current vrep position, or none if not wanted in the scene
    ...
    sceneParameters.sample0_StartingPosition = [0.8, -0.15]  # starting position of obstacle 0 [x, y] (in metres), -1 if want to use current vrep position, or none if not wanted in the scene
