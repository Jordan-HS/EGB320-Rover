...
def init_sim():
    ...
    sceneParameters.obstacle0_StartingPosition = [-0.6, -0.6]  # starting position of obstacle 0 [x, y] (in metres), -1 if want to use current vrep position, or none if not wanted in the scene
